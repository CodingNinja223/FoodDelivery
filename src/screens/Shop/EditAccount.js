        ...
        return(
          <ScrollView style={styles.container}>
              ...
              <Avatar
                ...
                <Divider style={{ backgroundColor: 'gray' }}  size="large"/>
                <View style={{margin:15}}>
                    <TouchableOpacity style={styles.containSpacing}>
                        <Text style={styles.fontColor}>First Name</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.containSpacing}>
                        <Text style={styles.fontColor}>Last Name</Text>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.containSpacing}>
